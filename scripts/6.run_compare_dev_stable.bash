...
then
   ...
   echo ""
   echo "${0} EXP_NAME RESOLUTION LABELI FCST DIR_SCRIPTS_CDCT_ESTABLE DIR_SCRIPTS_CDCT_DEV"
   echo ""
   ...
   echo "DIR_SCRIPTS_CDCT_ESTABLE :: Path the install Scripts CD-CT A (Stab)"
   echo "DIR_SCRIPTS_CDCT_DEV     :: Path the install Scripts CD-CT B (Dev)"
   echo ""
   echo "24 hour forcast example:"
   echo "${0} GFS 1024002 2024010100 24 /mnt/beegfs/<user>/<monan_dir_A>/scripts_CD-CT /mnt/beegfs/<user>/<monan_dir_B>/scripts_CD-CT"
   echo ""
